...
{{< hextra/feature-grid cols="3" >}}
  {{< hextra/feature-card class="jackadi_card" title="Distributed Execution" subtitle="Run tasks across multiple nodes from one manager.<br />Collect and store node system information." >}}
  ...
  {{< hextra/feature-card class="jackadi_card" title="Advanced Targeting" subtitle="Target nodes via list, glob, regex, queries or from file." >}}
{{< /hextra/feature-grid >}}
